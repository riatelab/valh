...
- [valhallr](https://github.com/chris31415926535/valhallr/): This package is on CRAN,
  but does not allow access to various Valhalla services (notably *height*, *locate*
  and *optimized route*). In addition, it calls on many heavy dependencies to install,
